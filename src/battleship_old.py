...
ocean_size = 5
ocean_user = [["- " for x in range(0, ocean_size)] for y in range(0, ocean_size)]
ocean_cpu = [["- " for a in range(0, ocean_size)] for b in range(0, ocean_size)]
count_cpu = 2
count_user = 2
...
def user_ships():
    flag = 0
    while flag == 0:
        user_place_row = int(input("Enter a number between 0-4\n->"))
        user_place_col = int(input("Enter a number between 0-4\n->"))
...
def cpu_ships():
    ...
    if (cpu_choice == 1):
        ...
        ocean_cpu[cpu_place_row][cpu_place_col] = "O"
        ocean_cpu[cpu_place_row+1][cpu_place_col] = "O"
...
def user_turn():
    ...
    user_move_row = 0
    while (flag == 0):
        user_move_row = int(input("Enter a number between 0 and 4\n->"))
        user_move_col = int(input("Enter a number between 0 and 4\n->"))
...
def cpu_turn():
    global count_user, cpu_move_row, cpu_move_col
    flag = 0
    while (flag == 0):
